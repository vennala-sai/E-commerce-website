...
public class EditProfileAdmin implements ActionListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EditProfileAdmin window = new EditProfileAdmin();
	...
	private void initialize() {
		...
		AdministratorServices service = new AdministratorServices();
		...
		btnSave.setBounds(440, 490, 103, 32);
		...
		btnBack.setBounds(10, 492, 103, 32);
